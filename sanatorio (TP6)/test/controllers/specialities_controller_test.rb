...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { charge: @speciality.charge, name: @speciality.name } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { charge: @speciality.charge, name: @speciality.name } }
