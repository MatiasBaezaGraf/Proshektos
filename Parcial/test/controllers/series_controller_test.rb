...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { descripcion: @series.descripcion, nombre: @series.nombre } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { descripcion: @series.descripcion, nombre: @series.nombre } }
