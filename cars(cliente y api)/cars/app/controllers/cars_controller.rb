class CarsController < ApplicationController
  ...
  def index
    ...
    @cars = @cars.where(:classification_id => params[:classification_id]) unless params[:classification_id].blank?
    @cars = @cars.where(:structure_id => params[:structure_id]) unless params[:structure_id].blank?
